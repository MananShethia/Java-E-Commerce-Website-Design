									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="pprice" type="number" placeholder="Product Price">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
										...
										<div class="col-12">
											<div class="form-group message">
												...
												<textarea name="pdesc" placeholder="Product Description"></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" name="action" value="addProduct" class="btn">add product</button>
											</div>
										</div>
									</div>
								</form>
