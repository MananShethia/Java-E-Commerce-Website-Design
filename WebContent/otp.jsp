				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="login.jsp">OTP Verification</a></li>
						</ul>
					</div>
				</div>
			</div>
									...
									<div class="row">
										...
										<div class="col-lg-12 col-12">
											<div class="form-group">
												...
												<input name="otp2" type="text" placeholder="OTP">
											</div>	
										</div>
										<div class="col-6">
											<div class="form-group button">
												<button type="submit" name="action" value="verifyOTP" class="btn">CHECK</button>
											</div>
										</div>
									</div>
								</form>
