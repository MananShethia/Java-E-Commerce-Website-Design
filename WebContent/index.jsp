						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link active" href="index.jsp?pc=all" role="tab">All</a></li>
									<li class="nav-item"><a class="nav-link" href="index.jsp?pc=men" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link" href="index.jsp?pc=women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link" href="index.jsp?pc=kids" role="tab">Kids</a></li>
									...
									<div class="tab-single">
										...
										<%
											...
											try{
												...
												if(pc == null || pc.equals("all"))
												{}
												else if(pc != null)
												{
													pc = request.getParameter("pc");
													list = ProductDao.getAllProductByCategory(pc);
												}
											}catch(Exception e)
											{
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.jsp"><%=p.getPname() %></a></h3>
