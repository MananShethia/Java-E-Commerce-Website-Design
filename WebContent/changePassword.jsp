				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="login.jsp">Change Password</a></li>
						</ul>
					</div>
				</div>
			</div>
									...
									<div class="row">
										...
										<div class="col-lg-12 col-12">
											<div class="form-group">
												<label>Your Old Password<span>*</span></label>
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="cnpassword" type="password" placeholder="Confirm New Password">
											</div>	
										</div>
										<div class="col-6">
											<div class="form-group button">
												<button type="submit" name="action" value="changepassword" class="btn">Confirm</button>
											</div>
										</div>
									</div>
								</form>
