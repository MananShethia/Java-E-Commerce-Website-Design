...
<body class="js">
	...
	<%
		List<Product> list = ProductDao.viewProductBySeller(u.getId());
	%>
									...
									<div class="tab-single">
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
													...
													<div class="product-img">
														...
														<!-- <div class="button-head">
															<div class="product-action">
																<a title="Details" href="#">View Details</a>
															</div>
														</div> -->
													</div>
												...
												<br>
												<a href="productDetail.jsp?pid=<%=p.getPid() %>">
													<input type="submit" name="action" value="View Details" class="btn btn-primary">
												</a>
											</div>
											<%
												}
