...
public class Services {
	...
	public static void sendMail(String emailid,int otp){
		final String username  = "javawebapp.404@gmail.com";//Sender Email
		final String password   = "webapp404";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "javawebapp.4046@gmail.com";
		final String password   = "webapp404";
